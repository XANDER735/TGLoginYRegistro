                ...
                <div class="col order-2 btn btn-success">
                                ...
                                <div class="row p-2 mb-0 justify-content-center">
                                        ...
                                        <div class="col-5" >
                                                ...
                                                <input class="form-control" name="longevidad" value="{{ $animal->longevidad }}" readonly>
                                ...
                                <div class="row p-2 mb-0 justify-content-evenly">   
                                    ...
                                    <div class="row g-2 justify-content-center">
                                        <div class="col-4">
                                            ...
                                            <input class="form-control" name="peso" value="{{ $animal->peso }}" readonly>
                                ...
                                <div class="row g-2 justify-content-end">
                                        <div class="col-5"><br>
                                                <div class="btn btn-warning"><a  class="navbar-brand"  href="{{ route('animales.index') }}"> «Regresar al Inicio</a></div>  
                                        </div>
                                </div>        
                </div>
     </div>
     <div class="row" >
                        <details class="accordion-item bg-secondary bg-gradient text-white">
                                ...
                                <div class="bg-light bg-gradient text-black" >
                                        <div class="accordion-body">{{ $animal->informacion }}</div>
                                </div>
                        </details>
                        <details class="accordion-item bg-secondary bg-gradient text-white">
                        <summary class="fs-4">
